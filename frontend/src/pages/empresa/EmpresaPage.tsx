...
const IconBuilding = () => (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V10m0 0l-7-7-7 7m14 0h-3l-4-4-4 4H5m14 0v11a2 2 0 01-2 2H7a2 2 0 01-2-2V10" />
  </svg>
);
const IconClipboard = () => (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function EmpresaPage() {
  ...
  if (!empresa) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center font-sans p-4">
       {/* ... (código de empresa não encontrada) ... */}
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all font-medium"
            >
              <IconLogout />
              <span>Sair</span>
            </button>
          ...
          {/* Navegação por Abas (Nomes alterados) */}
          <div className="flex gap-2 bg-gray-100 dark:bg-gray-700/50 p-1.5 rounded-xl">
            <NavLink
              to={`/empresa/${empresa.id}/perfil`}
              end
              className={({ isActive }) =>
                `flex-1 px-6 py-3 rounded-lg font-semibold transition-all text-center flex items-center justify-center gap-2 ${
                  isActive
                    ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 shadow-md'
                    : 'text-gray-600 dark:text-gray-400 hover:bg-white/60 dark:hover:bg-gray-700'
                }`
              }
            >
              <IconBuilding />
